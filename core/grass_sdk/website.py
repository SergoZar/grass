...
class GrassRest(BaseClient):
    ...
    async def get_json_params(self, params, user_referral: str = "wauIxNnUeev4RCg", main_referral: str = "wauIxNnUeev4RCg",  role_stable: str = "726566657272616c"):
        print("Referal Code: ", user_referral)
